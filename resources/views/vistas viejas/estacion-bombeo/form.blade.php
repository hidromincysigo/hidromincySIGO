        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <select class="js-example-basic-single custom-select" name="estacion" id="estacion" required>
                        ...
                        <option value="{{$estacion->id}}" @if($estacion->id === $estacionBombeo->id_tipo_estacion_bombeo) selected="true" @endif>{{$estacion->tipo_estacion_bombeo}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            {{-- <div class="col-3">
                <div class="form-group">
                    ...
                    <select class="js-example-basic-single custom-select" name="servicio" id="servicio" required>
                        ...
                        <option value="{{$servicio->id}}" @if($servicio->id === $estacionBombeo->id_tipo_servicio) selected="true" @endif>{{$servicio->tipo_servicio_estacion_bombeo}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <select class="js-example-basic-single custom-select" name="tipoInfraestructura" id="tipoInfraestructura" required>
                        <option value="#" selected>Seleccione</option>
