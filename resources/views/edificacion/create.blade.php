        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header col-12" style="background-color: #000066;">
                    <h3 class="card-title" style="color: white;">Diseño de la Edificación</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('infraestructura.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
