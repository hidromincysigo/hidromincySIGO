    ...
    <div class="login-form">
        ...
        @csrf
            <div class="group">
              ...
              <input id="email" type="text" class="input @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="{{ __('adminlte::adminlte.email') }}">
          </div>
          @error('email')
        ...
        <div class="group">
            ...
            <input id="password" type="password" class="input @error('password') is-invalid @enderror" data-type="password" placeholder="{{ __('adminlte::adminlte.password') }}">
        </div>
        @error('password')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
